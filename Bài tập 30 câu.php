...
function checkEvenNumber($number){
    if($number % 2 ==0){
        ...
        echo'Không là số chẵn';
    }
}
echo checkEvenNumber(5);
...
function addElement($arr, $element, $location) {
...
$element = 200;
$location = 5;
print_r(addElement($arr, $element, $location));
